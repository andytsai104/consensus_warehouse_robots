...
def generate_launch_description():
    ...
    rviz_config_file = os.path.join(pkg_bringup_sim, "config", "rviz_navigation.rviz")
    ...
    for idx in range(robot_num):
        ...
        # Nav2 Launch: Only pass the arguments that bringup_launch.py actually accepts
        nav2 = IncludeLaunchDescription(
            ...
            launch_arguments={
                ...
                "map": map_file,
                # REMOVED: robot_base_frame, global_frame, etc. 
                # (The launch file doesn't read these; it reads the params_file instead)
            }.items(),
        )
